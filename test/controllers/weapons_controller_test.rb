...
class WeaponsControllerTest < ActionController::TestCase
  ...
  test "should create weapon" do
    assert_difference('Weapon.count') do
      post :create, weapon: { weapon_def: @weapon.weapon_def, weapon_dmg: @weapon.weapon_dmg, weapon_name: @weapon.weapon_name, weapon_type: @weapon.weapon_type }
    end
  ...
  test "should update weapon" do
    patch :update, id: @weapon, weapon: { weapon_def: @weapon.weapon_def, weapon_dmg: @weapon.weapon_dmg, weapon_name: @weapon.weapon_name, weapon_type: @weapon.weapon_type }
    assert_redirected_to weapon_path(assigns(:weapon))
  end
